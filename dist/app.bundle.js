...
module.exports = __webpack_require__.p + "e885528428c954b19ec3.png";
...
function updateCount(count) {
  chrome.runtime.sendMessage({
    type: 'updateValue',
    number: JSON.stringify(count)
  }, function (response) {
    if (response == 'success') {
      return true;
    } else alert("database disconnected, refresh chrome extension");
  });
}
...
numContainer.addEventListener("input", function () {
